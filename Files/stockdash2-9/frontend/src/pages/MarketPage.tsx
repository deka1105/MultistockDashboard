                ...
                {rows.map((row: any) => {
                  ...
                  return (
                    <tr key={row.ticker}
                      ...
                      <td className="py-3 px-3 font-mono text-text-secondary text-xs tabular-nums">{formatVolume(row.volume)}</td>
                      <td className="py-3 px-3 font-mono text-text-secondary text-xs tabular-nums">{formatMarketCap(row.market_cap)}</td>
