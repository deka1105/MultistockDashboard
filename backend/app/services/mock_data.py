...
_TICKER_DB = [
    ...
    ('BRK.B', 'Berkshire Hathaway B', 'Financial Services', 'NYSE'),
    ...
    ('BAC', 'Bank of America', 'Financial Services', 'NYSE'),
    ('WFC', 'Wells Fargo', 'Financial Services', 'NYSE'),
    ...
    ('C', 'Citigroup Inc', 'Financial Services', 'NYSE'),
    ('USB', 'US Bancorp', 'Financial Services', 'NYSE'),
    ('PNC', 'PNC Financial', 'Financial Services', 'NYSE'),
    ('COF', 'Capital One', 'Financial Services', 'NYSE'),
    ('CB', 'Chubb Ltd', 'Financial Services', 'NYSE'),
    ('ICE', 'Intercontinental Exchange', 'Financial Services', 'NYSE'),
    ('CME', 'CME Group', 'Financial Services', 'NASDAQ'),
    ...
    ('CRWD', 'CrowdStrike', 'Technology', 'NASDAQ'),
    ...
    ('DASH', 'DoorDash Inc', 'Technology', 'NYSE'),
    ('ABNB', 'Airbnb Inc', 'Technology', 'NASDAQ'),
    ('COIN', 'Coinbase Global', 'Financial Services', 'NASDAQ'),
    ('RBLX', 'Roblox Corp', 'Communication Services', 'NYSE'),
    ('U', 'Unity Software', 'Technology', 'NYSE'),
    ('DOCN', 'DigitalOcean', 'Technology', 'NYSE'),
    ('MDB', 'MongoDB Inc', 'Technology', 'NASDAQ'),
    ('ESTC', 'Elastic NV', 'Technology', 'NYSE'),
    ('ZS', 'Zscaler Inc', 'Technology', 'NASDAQ'),
    ('OKTA', 'Okta Inc', 'Technology', 'NASDAQ'),
    ('TWLO', 'Twilio Inc', 'Technology', 'NYSE'),
    ...
    ('BSX', 'Boston Scientific', 'Healthcare', 'NYSE'),
    ('EW', 'Edwards Lifesciences', 'Healthcare', 'NYSE'),
    ('SYK', 'Stryker Corp', 'Healthcare', 'NYSE'),
    ('ZBH', 'Zimmer Biomet', 'Healthcare', 'NYSE'),
    ...
    ('MCD', "McDonald's Corp", 'Consumer Cyclical', 'NYSE'),
    ...
    ('TGT', 'Target Corp', 'Consumer Cyclical', 'NYSE'),
    ('BKNG', 'Booking Holdings', 'Consumer Cyclical', 'NASDAQ'),
    ('ABNB', 'Airbnb Inc', 'Consumer Cyclical', 'NASDAQ'),
    ('EXPE', 'Expedia Group', 'Consumer Cyclical', 'NASDAQ'),
    ('MAR', 'Marriott Intl', 'Consumer Cyclical', 'NASDAQ'),
    ('HLT', 'Hilton Worldwide', 'Consumer Cyclical', 'NYSE'),
    ('DIS', 'Walt Disney Co', 'Consumer Cyclical', 'NYSE'),
    ...
    ('VZ', 'Verizon Comms', 'Communication Services', 'NYSE'),
    ...
    ('GIS', 'General Mills', 'Consumer Defensive', 'NYSE'),
    ('K', 'Kellanova', 'Consumer Defensive', 'NYSE'),
    ('MDLZ', 'Mondelez Intl', 'Consumer Defensive', 'NASDAQ'),
    ('KHC', 'Kraft Heinz', 'Consumer Defensive', 'NASDAQ'),
    ...
    ('FANG', 'Diamondback Energy', 'Energy', 'NASDAQ'),
    ('HAL', 'Halliburton Co', 'Energy', 'NYSE'),
    ('RTX', 'Raytheon Technologies', 'Industrials', 'NYSE'),
    ('HON', 'Honeywell Intl', 'Industrials', 'NASDAQ'),
    ...
    ('ETN', 'Eaton Corp', 'Industrials', 'NYSE'),
    ('PH', 'Parker-Hannifin', 'Industrials', 'NYSE'),
    ('ITW', 'Illinois Tool Works', 'Industrials', 'NASDAQ'),
    ('FAST', 'Fastenal Co', 'Industrials', 'NASDAQ'),
    ('ROK', 'Rockwell Automation', 'Industrials', 'NYSE'),
    ('GWW', 'W.W. Grainger', 'Industrials', 'NYSE'),
    ('ODFL', 'Old Dominion Freight', 'Industrials', 'NASDAQ'),
    ('CHRW', 'CH Robinson', 'Industrials', 'NASDAQ'),
    ('XYL', 'Xylem Inc', 'Industrials', 'NYSE'),
    ('IEX', 'IDEX Corp', 'Industrials', 'NYSE'),
    ('NDSN', 'Nordson Corp', 'Industrials', 'NASDAQ'),
    ...
    ('VTI', 'Vanguard Total Market', 'ETF', 'NYSE'),
    ('VOO', 'Vanguard S&P 500', 'NYSE', 'NYSE'),
    ('GLD', 'SPDR Gold Trust', 'ETF', 'NYSE'),
    ('TLT', 'iShares 20+ Year Tsy', 'ETF', 'NASDAQ'),
    ('VXX', 'iPath S&P 500 VIX', 'ETF', 'CBOE'),
    ('ARKK', 'ARK Innovation ETF', 'ETF', 'NYSE'),
    ('SQQQ', 'ProShares UltraPro Short QQQ', 'ETF', 'NASDAQ'),
    ('TQQQ', 'ProShares UltraPro QQQ', 'ETF', 'NASDAQ'),
    ('NVDL', 'GraniteShares 2x NVDA', 'ETF', 'NYSE'),
]

def get_mock_search(query: str) -> list[dict]:
    """
    Search across 200+ tickers covering all major sectors, ETFs, and popular stocks.
    Matches ticker symbol or company name (case-insensitive).
    """
    q = query.strip().upper()
    results = []
    for symbol, name, sector, exchange in _TICKER_DB:
        if q in symbol or q in name.upper():
            results.append({
                ...
                "description": name,
                "name":        name,
                "type":        "ETP" if sector == "ETF" else "Common Stock",
                "exchange":    exchange,
                "sector":      sector,
            })
    # Sort: exact ticker match first, then prefix match, then contains
    results.sort(key=lambda r: (
        0 if r["symbol"] == q else
        1 if r["symbol"].startswith(q) else
