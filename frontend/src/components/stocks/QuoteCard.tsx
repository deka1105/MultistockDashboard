...
import { useQuickWatchlist, useIsInWatchlist } from '@/hooks/useStockData'
...
export default function QuoteCard({ quote, profile }: QuoteCardProps) {
  ...
  const inWatchlist = useIsInWatchlist(quote.ticker)
  ...
  const handleStarClick = () => {
    if (inWatchlist) removeFromWatchlist.mutate(quote.ticker)
    else             addToWatchlist.mutate(quote.ticker)
  }
