...
import { LayoutDashboard, GitCompare, Star, BarChart3, Briefcase, SlidersHorizontal, Bell, CalendarDays, TrendingUp, ChevronLeft, ChevronRight } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/screener',        label: 'Screener',   icon: SlidersHorizontal, exact: true },
